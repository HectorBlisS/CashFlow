...
//También podemos detectar si es móvil u ordenador usando else
    ...
    render(){
        ...
        return(
            <div style={center}>
                <form style={{padding:"3rem", width:"60%" }} onSubmit={this.handleSubmit}>
                    ...
                    <DropDownList data={categorias} nombre="categoria" handleChange={this.handleChange} etiqueta="Categoria"/>
                    <DropDownList data={tipoPago} nombre="tipoPago" handleChange={this.handleChange} etiqueta="Tipo de pago"/>
